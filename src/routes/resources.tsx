  ...
  return (
    <div className="flex flex-col gap-10 w-full animate-fade-in py-12 px-4 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {tips.map((tip, i) => (
          <div key={i} className="glass-card group p-8 rounded-3xl border-white/5 hover:border-primary/20 transition-all duration-500">
      ...
      <div className="relative overflow-hidden p-10 glass-card rounded-[2.5rem] border-white/5">
