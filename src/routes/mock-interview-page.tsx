  ...
  return (
    <div className="flex flex-col w-full gap-8 py-5">
      ...
      <div className="w-full">
        <Alert className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg flex items-start gap-3">
          <Lightbulb className="h-5 w-5 text-emerald-400" />
          <div>
            <AlertTitle className="text-emerald-400 font-semibold">
              Important Note
            </AlertTitle>
            <AlertDescription className="text-sm text-emerald-400/90 mt-1 leading-relaxed">
